...
const CardDetail = () => {
  ...
  const suitInfo: Record<string, { name: string; element: string; color: string; desc: string }> = {
    ...
    wands: { name: t('gallery.wands'), element: '🔥 ' + (isZh ? '火元素' : 'Fire'), color: 'text-orange-400', desc: t('gallery.wandsDesc') },
    cups: { name: t('gallery.cups'), element: '💧 ' + (isZh ? '水元素' : 'Water'), color: 'text-blue-400', desc: t('gallery.cupsDesc') },
    swords: { name: t('gallery.swords'), element: '🌬️ ' + (isZh ? '风元素' : 'Air'), color: 'text-cyan-400', desc: t('gallery.swordsDesc') },
    pentacles: { name: t('gallery.pentacles'), element: '🌍 ' + (isZh ? '土元素' : 'Earth'), color: 'text-yellow-400', desc: t('gallery.pentaclesDesc') },
    coins: { name: t('gallery.pentacles'), element: '🌍 ' + (isZh ? '土元素' : 'Earth'), color: 'text-yellow-400', desc: t('gallery.pentaclesDesc') },
  };
