        ...
        <AnimatePresence mode="wait">
          ...
          {step === 'result' && fortune && (
            ...
            >
              ...
              >
                <div className="relative w-full h-full" style={{ transformStyle: 'preserve-3d' }}>
                  <div className="absolute inset-0 rounded-2xl overflow-hidden shadow-2xl shadow-purple-900/30" style={{ backfaceVisibility: 'hidden' }}>
                    <div className={fortune.cardOrientation === 'reversed' || fortune.cardOrientation === '逆位' ? 'w-full h-full rotate-180' : 'w-full h-full'}>
              ...
              <div className="text-center">
                <p className="text-white font-medium">{fortune.cardName} · {fortune.cardOrientation}</p>
